...
#LD
scoreboard players operation tmp_RLA craftboy = out binary
#LD
scoreboard players operation in binary = tmp_RLA craftboy
function util:binary_split0
#LD
scoreboard players operation cflag_RLA craftboy = 7_0 binary
#LD
...
#LD
scoreboard players operation 0_0 binary = C flags
...
function util:binary_split0
scoreboard players operation 4_0 binary = cflag_RLA craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_C craftboy = out binary
#SET_F
