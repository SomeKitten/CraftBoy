...
#CALLC
execute if score 4_0 binary matches 1 run function instructions:205
execute unless score 4_0 binary matches 1 run scoreboard players add PC registers 2
