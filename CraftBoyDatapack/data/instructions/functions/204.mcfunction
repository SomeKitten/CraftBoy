...
#CALLC
execute if score 7_0 binary matches 1 run function instructions:205
execute unless score 7_0 binary matches 1 run scoreboard players add PC registers 2
