...
#LD
scoreboard players operation tmp_BIT craftboy = out binary
#BIT
#GET_BIT
#LD
scoreboard players operation in binary = tmp_BIT craftboy
function util:binary_split0
#LD
scoreboard players operation out binary = 2_0 binary
#LD
scoreboard players operation tmp_BIT craftboy = out binary
#INV_BIT
scoreboard players operation tmp_INV binary = 1 constants
scoreboard players operation tmp_INV binary -= tmp_BIT craftboy
scoreboard players operation tmp_BIT craftboy = tmp_INV binary
#SET_FLAG_Z
#GET_F
#GET_LO16
#LD
...
function util:binary_split0
scoreboard players operation 7_0 binary = tmp_BIT craftboy
