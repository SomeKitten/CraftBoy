...
#LD
scoreboard players operation tmp_RRC craftboy = 0_0 binary
#LD
...
#LD
scoreboard players operation 7_0 binary = tmp_RRC craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_ROT craftboy = out binary
scoreboard players set zflag_RRC craftboy 0
...
function util:binary_split0
scoreboard players operation 7_0 binary = zflag_RRC craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_Z craftboy = out binary
#SET_F
...
function util:binary_split0
scoreboard players operation 4_0 binary = tmp_RRC craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_C craftboy = out binary
#SET_F
