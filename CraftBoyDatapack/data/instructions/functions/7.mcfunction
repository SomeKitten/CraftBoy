...
#LD
scoreboard players operation tmp_RLCA craftboy = 7_0 binary
#LD
...
#LD
scoreboard players operation 0_0 binary = tmp_RLCA craftboy
...
function util:binary_split0
scoreboard players operation 4_0 binary = tmp_RLCA craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_C craftboy = out binary
#SET_F
