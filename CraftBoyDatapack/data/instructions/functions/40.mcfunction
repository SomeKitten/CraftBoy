...
#M_CYCLES_C
execute if score 7_0 binary matches 1 run scoreboard players set m_cycles craftboy 3
execute unless score 7_0 binary matches 1 run scoreboard players set m_cycles craftboy 2
function util:get_d
#JRC
execute if score 7_0 binary matches 1 run scoreboard players operation PC registers += d craftboy
