...
#LD
scoreboard players operation tmp2_SUB craftboy = tmp_SUB_A craftboy
scoreboard players operation tmp_SUB_A craftboy -= n craftboy
#GET_LO8
#LD
scoreboard players operation in binary = tmp2_SUB craftboy
...
execute if score n craftboy > tmp2_SUB craftboy run scoreboard players set cflag_SUB craftboy 1
