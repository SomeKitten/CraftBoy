...
#LD
scoreboard players operation tmp_RRA craftboy = out binary
#LD
scoreboard players operation in binary = tmp_RRA craftboy
function util:binary_split0
#LD
scoreboard players operation cflag_RRA craftboy = 0_0 binary
#LD
...
function util:binary_split0
scoreboard players operation 4_0 binary = cflag_RRA craftboy
function util:binary_join0
#LD
scoreboard players operation tmp_C craftboy = out binary
#SET_F
