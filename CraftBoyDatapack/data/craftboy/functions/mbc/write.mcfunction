...
execute if score index craftboy matches 0..8191 if score 327 rom matches 252 run function craftboy:mbc/ram_gate
...
execute if score index craftboy matches 8192..12287 if score 327 rom matches 252 run function craftboy:mbc/swap_rom_lo_mbc5
...
# execute if score index craftboy matches 8192..16383 if score 327 rom matches 252 run function craftboy:mbc/swap_rom_camera
...
# execute if score index craftboy matches 16384..24575 if score 327 rom matches 252 run function craftboy:mbc/clear_ram
