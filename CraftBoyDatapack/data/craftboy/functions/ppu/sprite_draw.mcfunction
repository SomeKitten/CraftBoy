...
execute if score 5_4 binary matches 0 at @s run function craftboy:ppu/sprite_row
execute if score 5_4 binary matches 1 at @s run function craftboy:ppu/sprite_row_flipped